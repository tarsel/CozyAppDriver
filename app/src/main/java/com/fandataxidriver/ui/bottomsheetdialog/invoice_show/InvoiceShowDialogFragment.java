package com.fandataxidriver.ui.bottomsheetdialog.invoice_show;
...
import com.fandataxidriver.data.network.model.Payment;
...
public class InvoiceShowDialogFragment extends BaseBottomSheetDialogFragment {
    ...
    private void init() {
        if (MvpApplication.DATUM_history_detail != null) {
            lblBookingid.setText(MvpApplication.DATUM_history_detail.getBookingId());
            lblDistanceTravelled.setText(MvpApplication.DATUM_history_detail.getDistance() + "");
            lblTimetaken.setText(MvpApplication.DATUM_history_detail.getTravelTime() + "");

            Payment payment = MvpApplication.DATUM_history_detail.getPayment();
            if (payment != null) {
                lblBasreFare.setText((AppConstant.Currency + " " +
                        MvpApplication.getInstance().getNewNumberFormat(Double.parseDouble(payment.getFixed() + ""))));
                lblTax.setText((AppConstant.Currency + " " +
                ...
                if (payment.getTips() == 0 || payment.getTips() == 0.0)
                    ...
                    lblTips.setText((AppConstant.Currency + " " +
                ...
                lblTotal.setText((AppConstant.Currency + " " +
                ...
                if (payment.getPayable() > 0) {
                    ...
                    lblPaid.setText((AppConstant.Currency + " " +
                    ...
                    switch (serviceCalculator) {
                        ...
                        case AppConstant.InvoiceFare.DISTANCEMIN:
                            ...
                            lblDistanceFare.setText(AppConstant.Currency + " " +
                                    MvpApplication.getInstance().getNewNumberFormat(payment.getDistance()));
                            break;
                        case AppConstant.InvoiceFare.DISTANCEHOUR:
                            distanceContainer.setVisibility(View.GONE);
                            timeContainer.setVisibility(View.GONE);
                            lblTimeFare.setText(AppConstant.Currency + " " +
                                    MvpApplication.getInstance().getNewNumberFormat(payment.getHour()));
