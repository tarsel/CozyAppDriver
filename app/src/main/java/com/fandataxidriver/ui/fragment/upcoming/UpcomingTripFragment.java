...
import com.fandataxidriver.ui.activity.upcoming_detail.UpcomingTripDetailActivity;
import com.fandataxidriver.ui.adapter.UpcomingTripAdapter;
...
public class UpcomingTripFragment extends BaseFragment implements UpcomingTripIView,
    ...
    public void cancelRide(HistoryList historyList, int pos) {
        ...
        MvpApplication.DATUM_history = historyList;
        SharedHelper.putKey(getContext(), AppConstant.SharedPref.CANCEL_ID, String.valueOf(MvpApplication.DATUM_history.getId()));
