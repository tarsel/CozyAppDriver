...
import com.fandataxidriver.ui.activity.add_card.AddCardActivity;
import com.fandataxidriver.ui.activity.document.DocumentActivity;
import com.fandataxidriver.ui.activity.earnings.EarningsActivity;
import com.fandataxidriver.ui.activity.invite.InviteActivity;
import com.fandataxidriver.ui.activity.profile.ProfileActivity;
import com.fandataxidriver.ui.activity.setting.SettingsActivity;
import com.fandataxidriver.ui.activity.summary.SummaryActivity;
import com.fandataxidriver.ui.activity.wallet.WalletActivity;
...
import com.fandataxidriver.common.ChatHeadService;
import com.fandataxidriver.common.GPSTracker;
import com.fandataxidriver.common.LocaleHelper;
import com.fandataxidriver.common.PolyUtil;
...
import com.fandataxidriver.ui.activity.card.CardActivity;
import com.fandataxidriver.ui.activity.help.HelpActivity;
import com.fandataxidriver.ui.activity.instant_ride.InstantRideActivity;
import com.fandataxidriver.ui.activity.invite_friend.InviteFriendActivity;
import com.fandataxidriver.ui.activity.notification_manager.NotificationManagerActivity;
import com.fandataxidriver.ui.activity.your_trips.YourTripActivity;
import com.fandataxidriver.ui.bottomsheetdialog.invoice_flow.InvoiceDialogFragment;
import com.fandataxidriver.ui.bottomsheetdialog.rating.RatingDialogFragment;
import com.fandataxidriver.ui.fragment.incoming_request.IncomingRequestFragment;
import com.fandataxidriver.ui.fragment.offline.OfflineFragment;
import com.fandataxidriver.ui.fragment.status_flow.StatusFlowFragment;
...
import static com.fandataxidriver.MvpApplication.DATUM;
import static com.fandataxidriver.MvpApplication.DEFAULT_ZOOM;
import static com.fandataxidriver.MvpApplication.PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION;
import static com.fandataxidriver.MvpApplication.canGoToChatScreen;
import static com.fandataxidriver.MvpApplication.isChatScreenOpen;
import static com.fandataxidriver.MvpApplication.mLastKnownLocation;
import static com.fandataxidriver.common.AppConstant.checkStatus.ARRIVED;
import static com.fandataxidriver.common.AppConstant.checkStatus.PICKEDUP;
import static com.fandataxidriver.common.AppConstant.checkStatus.STARTED;
...
public class MainActivity extends BaseActivity implements
    ...
    private final LatLng mDefaultLocation = new LatLng(7.950435815021365, -1.0235380692755918);
