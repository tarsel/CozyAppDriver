...
public class InviteFriendActivity extends BaseActivity implements InviteFriendIView {
    ...
    private void updateUI() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            referral_amount.setText(Html.fromHtml(SharedHelper.getKey(this, AppConstant.ReferalKey.REFERRAL_TOTAL_TEXT), Html.FROM_HTML_MODE_COMPACT));
        } else {
            invite_friend.setText(Html.fromHtml(SharedHelper.getKey(this, AppConstant.ReferalKey.REFERRAL_TEXT)));
            referral_amount.setText(Html.fromHtml(SharedHelper.getKey(this, AppConstant.ReferalKey.REFERRAL_TOTAL_TEXT)));
        }
    }
