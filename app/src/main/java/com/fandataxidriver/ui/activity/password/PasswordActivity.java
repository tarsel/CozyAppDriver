...
public class PasswordActivity extends BaseActivity implements PasswordIView {
    ...
    public void initView() {
        ...
        if (extras != null) {
            email = extras.getString(AppConstant.SharedPref.EMAIL);
        ...
        if (SharedHelper.getKeyFCM(this, AppConstant.SharedPref.DEVICE_TOKEN).isEmpty()) {
            FirebaseInstanceId.getInstance().getInstanceId().addOnCompleteListener(task -> {
                ...
                SharedHelper.putKeyFCM(PasswordActivity.this, AppConstant.SharedPref.DEVICE_TOKEN, task.getResult().getToken());
            });
        }
...
//                startActivity(new Intent(this, ForgotActivity.class));
        ...
        if (TextUtils.isEmpty(deviceToken))
            FirebaseInstanceId.getInstance().getInstanceId().addOnSuccessListener(this, new OnSuccessListener<InstanceIdResult>() {
                ...
                public void onSuccess(InstanceIdResult instanceIdResult) {
                    ...
                    SharedHelper.putKeyFCM(PasswordActivity.this, AppConstant.SharedPref.DEVICE_TOKEN, deviceToken);
                }
            });
    ...
    public void onSuccess(ForgotResponse forgotResponse) {
        hideLoading();
        SharedHelper.putKey(this, AppConstant.SharedPref.TXT_EMAIL, email);
