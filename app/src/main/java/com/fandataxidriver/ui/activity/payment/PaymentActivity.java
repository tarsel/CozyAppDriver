...
import static com.fandataxidriver.MvpApplication.isBraintree;
import static com.fandataxidriver.MvpApplication.isCard;
import static com.fandataxidriver.MvpApplication.isCash;
import static com.fandataxidriver.MvpApplication.isPaytm;
import static com.fandataxidriver.MvpApplication.isPayumoney;
...
//        object.put("card_id", card.getCardId());

        new android.app.AlertDialog.Builder(this)
                .setMessage("Are you sure you want to delete")
                .setIcon(android.R.drawable.ic_dialog_alert)
                .setPositiveButton("Delete", (dialog, whichButton) -> presenter.deleteCard(card.getCardId()))
                .setNegativeButton(getString(R.string.no), null).show();

//        }catch (Exception e){
//            Log.d("CARD", "deleteCard: "+ e);
//
//        }
    }
    ...
    @OnClick({R.id.cash,R.id.add_card, R.id.braintree, R.id.paytm, R.id.payumoney})
