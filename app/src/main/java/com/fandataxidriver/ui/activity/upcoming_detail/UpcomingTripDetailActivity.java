...
public class UpcomingTripDetailActivity extends BaseActivity implements UpcomingTripDetailIView, EasyPermissions.PermissionCallbacks {
    ...
    public void initView() {
        ...
        if (MvpApplication.DATUM_history != null) {
            presenter.getUpcomingDetail(String.valueOf(MvpApplication.DATUM_history.getId()));
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.cancel:
                SharedHelper.putKey(getBaseContext(), AppConstant.SharedPref.CANCEL_ID, String.valueOf(MvpApplication.DATUM_history.getId()));
                cancelRequestPopup();
                break;
            case R.id.call:
                callTask();
    ...
    @AfterPermissionGranted(AppConstant.RC_CALL_PHONE)
