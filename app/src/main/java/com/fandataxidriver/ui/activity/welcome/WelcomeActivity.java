package com.fandataxidriver.ui.activity.welcome;
...
import com.fandataxidriver.data.network.model.Walkthrough;
import com.fandataxidriver.ui.activity.email.EmailActivity;
import com.fandataxidriver.ui.activity.regsiter.RegisterActivity;
import com.fandataxidriver.ui.activity.sociallogin.SocialLoginActivity;
...
public class WelcomeActivity extends BaseActivity implements
    ...
    public void initView() {
        ...
        list.add(new Walkthrough(R.drawable.welcome_1,
                getString(R.string.walk_1), getString(R.string.walk_1_description)));
        list.add(new Walkthrough(R.drawable.welcome_2,
                getString(R.string.walk_2), getString(R.string.walk_2_description)));
        list.add(new Walkthrough(R.drawable.welcome_3,
