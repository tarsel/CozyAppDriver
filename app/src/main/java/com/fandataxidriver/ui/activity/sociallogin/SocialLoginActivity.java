...
public class SocialLoginActivity extends BaseActivity implements SocialLoginIView {
        ...
        LoginManager.getInstance().registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            public void onSuccess(LoginResult loginResult) {
                if (AccessToken.getCurrentAccessToken() != null) {
                    map.put("login_by", AppConstant.Login.FACEBOOK);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        } else if (requestCode == AppConstant.APP_REQUEST_CODE && data != null) {
                ...
                AccountKit.getCurrentAccount(new AccountKitCallback<Account>() {
                    ...
                    public void onSuccess(Account account) {
                        ...
                        if (AccountKit.getCurrentAccessToken().getToken() != null) {
                            ...
                            SharedHelper.putKey(SocialLoginActivity.this, AppConstant.SharedPref.DIAL_CODE,
                                    "+" + phoneNumber.getCountryCode());
                            SharedHelper.putKey(SocialLoginActivity.this, AppConstant.SharedPref.MOBILE,
