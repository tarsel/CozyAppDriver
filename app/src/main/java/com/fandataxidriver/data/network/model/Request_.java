...
public class Request_ {
    ...
    @SerializedName("user_request_delivery_detail")
    @Expose
    private ArrayList<user_request_delivery_detail> delivery_detail;

    public ArrayList<user_request_delivery_detail> getDelivery_detail() {
        return delivery_detail;
    }

    public void setDelivery_detail(ArrayList<user_request_delivery_detail> delivery_detail) {
