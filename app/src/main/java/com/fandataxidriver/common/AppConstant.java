...
public class AppConstant {
    ...
    public static final String LANGUAGE_Dhaka = "bn";
    public static final int RC_CALL_PHONE = 123;
    public static int APP_REQUEST_CODE = 99;
    public static String Currency = "PKR";
    public static boolean showOTP;
    public static final String userAppPackageName = "com.Eazydriver";
    public static final String DEFAULT_COUNTRY_DIAL_CODE = "+92";
    public static final String DEFAULT_COUNTRY_CODE = "PAK";
